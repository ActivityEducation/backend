...
export class EducationPubController {
  ...
  @UseGuards(JwtAuthGuard, AbilitiesGuard)
  @CheckAbilities(['update', FlashcardEntity.name, { creator: { id: '{{user.id}}' } }])
  @ApiBearerAuth('JWT-auth')
  ...
  @UseGuards(JwtAuthGuard, AbilitiesGuard)
  @CheckAbilities(['delete', FlashcardEntity.name, { creator: { id: '{{user.id}}' } }])
  @ApiBearerAuth('JWT-auth')
  ...
  @UseGuards(JwtAuthGuard, AbilitiesGuard)
  @CheckAbilities(['like', FlashcardEntity.name])
  ...
  @HttpCode(HttpStatus.ACCEPTED)
  @UseGuards(JwtAuthGuard, AbilitiesGuard)
  @CheckAbilities(['boost', FlashcardEntity.name])
